            ...
            >
                <Table className='min-w-full'>
                    <TableHead>
                        <TableRow>
                            <TableCell
                                className={`py-2 px-4 font-bold border cursor-pointer ${sortConfig.key === 'profileId' && 'bg-gray-200'
                                    }`}
                            ...
                            <TableCell
                                className={`py-2 px-4 font-bold border cursor-pointer ${sortConfig.key === 'country' && 'bg-gray-200'
                                    }`}
                            ...
                            <TableCell
                                className={`py-2 px-4 border cursor-pointer ${sortConfig.key === 'marketplace' && 'bg-gray-200'
                                    }`}
                    ...
                    <TableBody>
                        {paginatedData.map(profile => (
                            <TableRow
                                ...
                                onClick={() => navigate('/accounts/:accountId/campaigns')}
